...
--
-- Хост: localhost
-- Время создания: Ноя 30 2012 г., 18:28
...
INSERT INTO `question_answer_types` (`id`, `name`, `category_id`) VALUES
(1, 'Basic', 3),
(2, 'Basic', 1),
(3, 'Queries', 1);
...
(8, 'admin', '44a5f1993a1bce7775518d770bbdb2f018e7902a335b3689e675037d0f76e1c9', 15, 1354285718);
...
ALTER TABLE `questions`
  ...
  ADD CONSTRAINT `questions_ibfk_5` FOREIGN KEY (`qestion_answer_type_id`) REFERENCES `question_answer_types` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `question_answer_types`
  ADD CONSTRAINT `question_answer_types_ibfk_1` FOREIGN KEY (`category_id`) REFERENCES `categories` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
