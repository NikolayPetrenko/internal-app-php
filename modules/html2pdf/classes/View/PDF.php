...
class View_PDF extends View {
	...
	public function render($file = NULL, $file2 = FALSE, $questions = FALSE) 
         {
                ...
                $html2pdf->pdf->SetDefaultMonospacedFont('dejavusans');
                $html2pdf->pdf->SetFont('dejavusans', '', 14, '', true);
                ...
                if($file2){
                    ...
                    $html2 = Kohana_View::factory($file2)->set('questions', $questions)->render();
